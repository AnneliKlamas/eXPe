...
public class chooseYourActivity extends AppCompatActivity {
    ...
    private Tegevus t4 = new Tegevus("Botanical garden2", "Visit the botanical garden.", "Kew Gardens is the world's largest collection of living plants situated in London", true, 8);
    private Tegevus[] arr = {t1, t2,t3, t4};
    private Button bt1;
    private Button bt2;
